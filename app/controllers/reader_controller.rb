class ReaderController < ApplicationController
  def index
    ...
    if keywords==nil or keywords==""
      ...
      search_expression = "(@weight*"+ (search_bin.weight_keyword/100).to_s() + "+ hasurl*"+search_bin.weight_hasurl.to_s()+"+1/(1+exp(-num_of_retweets/50.0))*"+search_bin.weight_retweet.to_s()+"+(post_date)/145152.0/2*"+search_bin.weight_freshness.to_s()+")";
